...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Скорая помощь Бишкек - Работаем 24/7",
    description:
      "Приедем в течении 15 минут - Частная-Скорая помощь Бишкек",
  ...
  return (
    <html lang="ru">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
        ...
        {/* Google Tag (gtag.js) */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=AW-17579366246"
        ...
        <Script id="gtag-init" strategy="afterInteractive">
          {`
            ...
            gtag('js', new Date());
            gtag('config', 'AW-17579366246');
          `}
        </Script>

        {/* Conversion Event */}
        <Script id="gtag-conversion" strategy="afterInteractive">
          {`gtag('event', 'conversion', {'send_to': 'AW-17579366246/uUG_CICGkp0bEOauv75B'});`}
        </Script>
      </body>
    </html>
  );
