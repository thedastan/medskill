				...
				<div className="flex md:flex-row flex-col justify-between   items-center">
					<div className="flex flex-col gap-[30px] md:gap-[50px] pt-5 w-full items-center md:items-start">
						...
						<a
							...
							className="bg-[#f0f0f0] md:flex justify-center items-center hidden w-full max-w-[210px] h-[70px] text-[20px] text-[#00a1b4] font-[600] rounded-[15px] shadow-[inset_-2px_-2px_4px_rgba(0,0,0,0.2),_inset_3px_4px_10px_#ffffff]">
							Позвонить сейчас
						</a>
					</div>
					...
					<a
						...
						className="bg-[#f0f0f0] flex justify-center items-center md:hidden mt-10 w-full max-w-[210px] h-[70px] text-[20px] text-[#00a1b4] font-[600] rounded-[15px] shadow-[inset_-2px_-2px_4px_rgba(0,0,0,0.2),_inset_3px_4px_10px_#ffffff]">
						Позвонить сейчас
					</a>
				</div>
